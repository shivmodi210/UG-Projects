...
title('Cutting Force (140k RPM, 2.5 um FPT)','fontweight','bold')
subplot(312)
plot(angle,Fy)
...
figure(2)
surf(X, Y, H)
% title('Floor Surface (140k RPM, 2.5 um FPT)','fontweight','bold')
...
figure(3)
plot(X,center)
title('Surafce Profile of Center (140k RPM, 2.5 um FPT)','fontweight','bold')
xlabel('X (um)','fontweight','bold')
ylabel('Height (um)','fontweight','bold')
saveas(3,'E-5-center.png')

figure(4)
plot(X,side)
title('Surafce Profile of 25 um far from side (140k RPM, 2.5 um FPT)','fontweight','bold')
xlabel('X (um)','fontweight','bold')
ylabel('Height (um)','fontweight','bold')
saveas(4,'E-5-side.png')
...
subplot(211)
plot(angle,dx)
title('Tool Vibrations (140k RPM, 2.5 um FPT)','fontweight','bold')
